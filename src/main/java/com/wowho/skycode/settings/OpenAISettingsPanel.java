...
package com.wowho.skycode.settings;
...
import com.wowho.skycode.icons.ChatGPTIcons;
import com.wowho.skycode.message.ChatGPTBundle;
import com.wowho.skycode.ui.SupportDialog;
import com.wowho.skycode.util.OpenAIUtil;
import com.wowho.skycode.MyToolWindowFactory;
...
public class OpenAISettingsPanel implements Configurable, Disposable {
    ...
    private final String[] comboboxItemsString = {
            MyToolWindowFactory.CHATGPT_CONTENT_NAME,
            MyToolWindowFactory.GPT35_TRUBO_CONTENT_NAME,
            MyToolWindowFactory.ONLINE_CHATGPT_CONTENT_NAME};
    ...
    public void apply() {
        ...
        boolean readTimeoutIsNumber = com.wowho.skycode.util.StringUtil.isNumber(readTimeoutField.getText());
        boolean connectionTimeoutIsNumber = com.wowho.skycode.util.StringUtil.isNumber(connectionTimeoutField.getText());
        ...
        boolean portIsNumber = com.wowho.skycode.util.StringUtil.isNumber(portField.getValue().toString());
