...
package com.wowho.godgpt.settings;
...
import com.wowho.godgpt.ui.SupportDialog;
import com.wowho.godgpt.util.OpenAIUtil;
import com.wowho.godgpt.MyToolWindowFactory;
...
public class OpenAISettingsPanel implements Configurable, Disposable {
    ...
    public void apply() {
        ...
        boolean readTimeoutIsNumber = com.wowho.godgpt.util.StringUtil.isNumber(readTimeoutField.getText());
        boolean connectionTimeoutIsNumber = com.wowho.godgpt.util.StringUtil.isNumber(connectionTimeoutField.getText());
        ...
        boolean portIsNumber = com.wowho.godgpt.util.StringUtil.isNumber(portField.getValue().toString());
